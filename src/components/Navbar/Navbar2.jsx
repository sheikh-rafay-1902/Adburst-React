  ...
  >
    <div className="container mx-auto px-4 py-4 flex justify-between items-center">
      ...
      <div className="hidden md:flex space-x-10 font-semibold">
        ...
        <div className="relative z-50"> {/* Ensure this parent has higher stacking context */}
          <button
            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
            className="hover:text-[#5f63ac] transition duration-300 transform hover:scale-105 z-20"
          >
            Get Started
          </button>
